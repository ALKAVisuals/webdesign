  ...
  return (
    <div className="relative px-4 py-6 mx-auto w-full overflow-hidden">
      ...
      <BlurredOrb
        ...
        style={{
          background: `radial-gradient(circle at center, var(--color-hero-start) 0%, var(--color-hero-mid) 50%, var(--color-hero-end) 100%)`,
        }}
      />
      ...
      <section className="flex flex-row items-center justify-between gap-4 border-t border-border py-4 mx-4">
        <div className="h-12 w-12 bg-muted-foreground/70 dark:bg-muted p-3 rounded-full flex items-center justify-center">
