  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="w-full max-w-7xl h-64 lg:h-96 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-xl lg:rounded-[2.5rem] flex items-center justify-center">
